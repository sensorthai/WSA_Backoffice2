      ...
      <div className="w-full max-w-md space-y-8 bg-white p-10 rounded-2xl shadow-xl border border-slate-100">
        <div className="flex flex-col items-center">
          ...
          <div className="h-16 w-16 bg-blue-600 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-blue-200">
            <span className="text-white text-2xl font-bold">SME</span>
          </div>
        ...
        <div className="mt-8 space-y-6">
          <Button
            ...
            className="w-full flex items-center justify-center gap-3 py-6 text-lg font-medium bg-white hover:bg-slate-50 text-slate-700 border-2 border-slate-200 rounded-xl transition-all hover:scale-[1.01] active:scale-95 shadow-sm"
          >
