...
| **13. Noticeboard & Holiday Calendar** | - **กระดานข่าวสาร:** Admin/CEO สร้างประกาศ 3 ประเภท (news, holiday, policy) แสดงผลให้พนักงานทุกคน<br>- **ปฏิทินวันหยุดปี 2569:** วันหยุดตามประเพณีสถาบันการเงิน 20 วัน อ้างอิงจาก ธปท. (bot.or.th)<br>- รองรับ Toggle ซ่อน/แสดงประกาศ และจัดการผ่าน UI | พนักงานทุกคน (ดู) / Admin, CEO (จัดการ) | `announcements` |
| **14. Doctor Appointment & Health Profile** | - **ข้อมูลสุขภาพ:** บันทึกหมู่เลือด, โรคประจำตัว, ภูมิแพ้, รพ.ประกันสังคม, แพทย์ประจำตัว<br>- **นัดหมายแพทย์:** สร้าง/แก้ไข/ลบ นัดหมาย พร้อมส่งอีเมลยืนยันทันที<br>- **Cron แจ้งเตือน:** ส่งอีเมลล่วงหน้า 7 วัน และ 1 วันก่อนนัดหมาย | พนักงานทุกคน / Admin | `doctor_appointments`, `users` (health fields) |
...
3. **📢 กระดานประกาศและปฏิทินวันหยุด (Noticeboard & Calendar):**
   - **✅ พร้อมใช้งานแล้ว** — ระบบประกาศข่าวสารภายในองค์กร รองรับ 3 ประเภท (news, holiday, policy) พร้อมระบบจัดการ (สร้าง/แก้ไข/ลบ/ซ่อน) สำหรับ Admin/CEO
   - **ปฏิทินวันหยุดประจำปี 2569:** แสดงวันหยุดตามประเพณีของสถาบันการเงิน อ้างอิงจากธนาคารแห่งประเทศไทย (ธปท.) จำนวน 20 วัน แบ่งตามเดือน
...
## 🏥 ระบบข้อมูลสุขภาพและการนัดหมายแพทย์ (Health Profile & Doctor Appointments)

ระบบบันทึกประวัติสุขภาพส่วนบุคคลและการนัดหมายแพทย์ เพื่อรองรับสวัสดิการพนักงาน:

### 📋 ข้อมูลสุขภาพ (Health Profile) — หน้า `/profile`
- บันทึกหมู่เลือด (Blood Type)
- โรคประจำตัว (Congenital Diseases)
- ประวัติการแพ้ยารุนแรง (Severe Allergies)
- โรงพยาบาลประกันสังคม (Social Security Hospital)
- แพทย์ประจำตัว (Attending Physician)
- โรงพยาบาลฉุกเฉิน (Emergency Hospital)
- ประวัติการตรวจสุขภาพ (Health Exam History)

### 🩺 การนัดหมายแพทย์ (Doctor Appointments) — หน้า `/profile`
- **สร้างนัดหมาย:** ระบุหัวข้อ, แพทย์, โรงพยาบาล, วัน/เวลานัดหมาย, หมายเหตุ
- **อีเมลยืนยัน:** ส่งอีเมลยืนยันทันทีที่สร้างนัดหมายสำเร็จ (`POST /api/profile/doctor-appointments`)
- **อีเมลแจ้งเตือนล่วงหน้า:** Cron job (`/api/cron/doctor-appointments`) ทำงานทุกวัน 09:00 น. — ส่งอีเมลเมื่อเหลือนัดหมาย **7 วัน** และ **1 วัน**
- **จัดการนัดหมาย:** แก้ไข หรือลบนัดหมายได้ตลอดเวลา
- **ตารางที่รองรับ:** `doctor_appointments`, `notifications`
